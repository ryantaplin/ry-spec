...
import test.resources.StubExtractClass;

import static org.assertj.core.api.Assertions.assertThat;
import static test.TestPath.getForClass;
...
class TestSourceCodeTest {
    ...
    void readSuccessfullyReturnsTestSourceCode() throws Exception {
        final TestPath emptyStubClass = getForClass("test.resources.EmptyStubExtractClass");
    ...
    void extractSuccessfullyExtractMethodContents() throws Exception {
        final TestPath testPath = getForClass("test.resources.StubExtractClass");
    ...
    public static final String EXPECTED_EMPTY_STUB_CLASS_SOURCE_CODE = "package test.resources;\n" +
            "\n" +
