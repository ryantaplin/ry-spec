...
class SourceCodeParserTest {
    ...
    public static final TestMethodSourceCode INPUT_SOURCE_CODE_EXAMPLE_1 = new TestMethodSourceCode("somethingFail() {\n" +
            "                Assertions.fail();\n" +
            "                }");

    public static final TestMethodSourceCode INPUT_SOURCE_CODE_EXAMPLE_2 = new TestMethodSourceCode("somethingFail(String input) {\n" +
